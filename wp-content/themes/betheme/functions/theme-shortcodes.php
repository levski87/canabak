			...
			if ($animate) {
				...
				if ($link) {
					...
					$output .= '<div class="desc_wrapper">';
						...
						if ($slogan) {
							$output .= '<p>'. wp_kses($slogan, mfn_allowed_title()) .'</p>';
						}
						if ($title) {
							$output .= '<h4>'. wp_kses($title, mfn_allowed_title()) .'</h4>';
						}
	...
	function sc_helper($attr, $content = null)
	{
		...
		$output = '<div class="helper">';
			...
			$output .= '<div class="helper_header">';
				...
				if ($title) {
					$output .= '<'. esc_attr($title_tag) .' class="title">'. wp_kses($title, mfn_allowed_title()) .'</'. esc_attr($title_tag) .'>';
				}
				...
				$output .= '<div class="links">';
					...
					if ($title1) {
						if ($link1) {
							// This variable has been safely escaped above in this function
							$output .= '<a class="link link-1 '. esc_attr($class1) .'" href="'. esc_url($link1) .'" '. $target_1_escaped .'>'. wp_kses($title1, mfn_allowed_title()) .'</a>';
						} else {
							$output .= '<a class="link link-1 toggle" href="#" data-rel="1">'. wp_kses($title1, mfn_allowed_title()) .'</a>';
						}
					}
					...
					if ($title2) {
						if ($link2) {
							// This variable has been safely escaped above in this function
							$output .= '<a class="link link-2 '. esc_attr($class2) .'" href="'. esc_url($link2) .'" '. $target_2_escaped .'>'. wp_kses($title2, mfn_allowed_title()) .'</a>';
						} else {
							$output .= '<a class="link link-2 toggle" href="#" data-rel="2">'. wp_kses($title2, mfn_allowed_title()) .'</a>';
						}
					}
			...
			if ($animate) {
				...
				if ($link) {
					...
					$output .= '<div class="desc_wrapper">';
						...
						if ($title) {
							$output .= '<h3 class="themecolor">'. wp_kses($title, mfn_allowed_title()) .'</h3>';
			...
			if ($animate) {
				...
				if ($link) {
					...
					$output .= '<div class="desc">';
						...
						if ($slogan) {
							$output .= '<div class="subtitle">'. wp_kses($slogan, mfn_allowed_title()) .'</div>';
						}
						if ($title) {
							$output .= '<h2>'. wp_kses($title, mfn_allowed_title()) .'</h2>';
						}
	...
	function sc_blog_slider($attr, $content = null)
	{
		...
		$output = '<div class="blog_slider clearfix '. esc_attr($classes) .'" data-count="'. intval($query_blog->post_count, 10) .'">';
			...
			$output .= '<div class="blog_slider_header">';
				if ($title) {
					$output .= '<h4 class="title">'. wp_kses($title, mfn_allowed_title()) .'</h4>';
				}
			$output .= '</div>';
				...
				while ($query_blog->have_posts()) {
					...
					$output .= '<li class="'. implode(' ', get_post_class()) .'">';
						$output .= '<div class="item_wrapper">';
							...
							if (get_post_format() == 'quote') {
								$output .= '<blockquote>';
									$output .= '<a href="'. esc_url(get_permalink()) .'">';
										$output .= wp_kses(get_the_title(), mfn_allowed_title());
									$output .= '</a>';
								$output .= '</blockquote>';
							} else {
							...
							$output .= '<div class="desc">';
								if (get_post_format() != 'quote') {
									$output .= '<h4><a href="'. esc_url(get_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_title()) .'</a></h4>';
								}
								$output .= '<hr class="hr_color" />';
					...
					$output .= '<li class="'. esc_attr(implode(' ', get_post_class())) .'">';
						...
						$output .= '<div class="desc">';
							...
							if ($first) {
								...
								$output .= '<h5><a href="'. esc_url(get_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_title()) .'</a></h5>';
							}
...
if (! function_exists('sc_blog_teaser')) {
	function sc_blog_teaser($attr, $content = null)
	{
		...
		$output = '<div class="blog-teaser '. esc_attr($class) .'">';
			...
			if ($title) {
				$output .= '<h3 class="title">'. wp_kses($title, mfn_allowed_title()) .'</h3>';
			}
						...
						$output .= '<div class="desc-wrapper">';
							$output .= '<div class="desc">';
								...
								$output .= '<div class="post-title">';
									$output .= '<h'. esc_attr($title_tag) .'><a href="'. esc_url(get_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_title()) .'</a></h'. esc_attr($title_tag) .'>';
								$output .= '</div>';
					...
					$output .= '<li class="'. esc_attr(implode(' ', get_post_class())) .'">';
						$output .= '<div class="item_wrapper">';
							...
							$output .= '<div class="desc">';
								...
								$output .= '<h4><a href="'. esc_url(get_the_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_title()) .'</a></h4>';
	...
	function sc_contact_box($attr, $content = null)
	{
		...
		if ($animate) {
			...
			$output .= '<div class="get_in_touch" '. $background_escaped .'>';
				...
				if ($title) {
					$output .= '<h3>'. wp_kses($title, mfn_allowed_title()) .'</h3>';
				}
...
if (! function_exists('sc_popup')) {
	function sc_popup($attr, $content = null)
	{
		...
		if ($button) {
			$output .= '<a href="#'. esc_attr($uid) .'" rel="prettyphoto" class="popup-link button button_js"><span class="button_label">'. wp_kses($title, mfn_allowed_title()) .'</span></a>';
		} else {
			$output .= '<a href="#'. esc_attr($uid) .'" rel="prettyphoto" class="popup-link">'. wp_kses($title, mfn_allowed_title()) .'</a>';
		}
		...
		$output = '<div class="pricing-box '. esc_attr($classes) .'">';
			...
			if ($animate) {
				...
				$output .= '<div class="plan-header">';
					...
					if ($subtitle) {
						$output .= '<p class="subtitle"><big>'. wp_kses($subtitle, mfn_allowed_title()) .'</big></p>';
					}
		...
		$output = '<div class="counter counter_'. esc_attr($type) .' '. esc_attr($animate_math) .'">';
			...
			if ($animate) {
				...
				$output .= '<div class="desc_wrapper">';
					...
					if ($title) {
						$output .= '<p class="title">'. wp_kses($title, mfn_allowed_title()) .'</p>';
					}
		...
		if ($animate) {
			...
			if ($link || $link_image) {
				...
				$output .= '<div class="image_frame image_item scale-with-grid'. esc_attr($class_div) .'" '. $style_escaped .'>';
					...
					if ($caption) {
						$output .= '<p class="wp-caption-text">'. wp_kses($caption, mfn_allowed_caption()) .'</p>';
					}
	...
	function sc_quick_fact($attr, $content = null)
	{
		...
		$output = '<div class="quick_fact align_'. esc_attr($align) .' '. esc_attr($animate_math) .'">';
			...
			if ($animate) {
				...
				if ($heading) {
					$output .= '<h4 class="title">'. wp_kses($heading, mfn_allowed_title()) .'</h4>';
				}
		...
		if ($hint || $image) {
			$output .= '<span class="tooltip tooltip-img">';
				...
				$output .= '<span class="tooltip-content">';
					...
					if ($hint) {
						$output .= wp_kses($hint, mfn_allowed_caption());
					}
...
if (! function_exists('sc_content_link')) {
	function sc_content_link($attr, $content = null)
	{
		...
		$output = '<a class="content_link '. esc_attr($class) .'" href="'. esc_url($link) .'" '. $target_escaped .' '. $download_escaped .'>';
			...
			if ($title) {
				$output .= '<span class="title">'. wp_kses($title, mfn_allowed_title()) .'</span>';
			}
		$output .= '</a>';
		...
		$output = '<div class="fancy_heading fancy_heading_'. esc_attr($style) .'">';
			...
			if ($animate) {
				...
				if ($style == 'line' && $slogan) {
					$output .= '<span class="slogan">'. wp_kses($slogan, mfn_allowed_title()) .'</span>';
				}

				if ($style =='arrows') {
					$title = '<i class="icon-right-dir"></i>'. wp_kses($title, mfn_allowed_title()) .'<i class="icon-left-dir"></i>';
				}

				if ($title) {
					if ($h1) {
						$output .= '<h1 class="title">'. wp_kses($title, mfn_allowed_title()) .'</h1>';
					} else {
						$output .= '<h2 class="title">'. wp_kses($title, mfn_allowed_title()) .'</h2>';
					}
				}
				if ($content) {
		...
		$output = '<div class="team team_'. esc_attr($style) .'">';
			...
			if ($animate) {
				...
				$output .= '<div class="desc_wrapper">';
					...
					if ($title) {
						$output .= '<h4>';
							if ($link) {
								...
								$output .= wp_kses($title, mfn_allowed_title());
							if ($link) {
								$output .= '</a>';
							}
						$output .= '</h4>';
					...
					if ($subtitle) {
						$output .= '<p class="subtitle">'. wp_kses($subtitle, mfn_allowed_title()) .'</p>';
					}
					if ($phone) {
						...
						$output .= '<li class="offer_li">';
							...
							$output .= '<div class="desc_wrapper align_'. esc_attr($align) .' '. esc_attr($class) .'">';
								...
								$output .= '<div class="title">';
									$output .= '<h3>'. wp_kses(get_the_title(), mfn_allowed_title()) .'</h3>';
									if ($link) {
										// This variable has been safely escaped above in this function
			...
			$output .= '<div class="jq-tabs tabs_wrapper tabs_'. esc_attr($type) .'">';
				...
				$output .= '<ul>';
					...
					foreach ($tabs_array as $tab) {
						...
						$output .= '<li><a href="#'. esc_attr($uid) .'-'. esc_attr($i) .'">'. wp_kses($tab['title'], mfn_allowed_title()) .'</a></li>';
				...
				if (is_array($tabs)) {
					...
					foreach ($tabs as $tab) {
						$output .= '<div class="question">';
							$output .= '<div class="title"><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>'. wp_kses($tab['title'], mfn_allowed_title()) .'</div>';
					...
					foreach ($tabs as $tab) {
						...
						$output .= '<div class="question">';
							...
							$output .= '<div class="title">';
								...
								$output .= '<i class="icon-plus acc-icon-plus"></i>';
								$output .= '<i class="icon-minus acc-icon-minus"></i>';
								$output .= wp_kses($tab['title'], mfn_allowed_title());
							$output .= '</div>';
	...
	function sc_timeline($attr, $content = null)
	{
		...
		$output  = '<ul class="timeline_items">';
			...
			if (is_array($tabs)) {
				...
				foreach ($tabs as $tab) {
					$output .= '<li>';
						$output .= '<h3>'. wp_kses($tab['title'], mfn_allowed_title()) .'</h3>';
						if ($tab['content']) {
							$output .= '<div class="desc">';
								$output .= do_shortcode($tab['content']);
							$output .= '</div>';
			...
			if ($animate) {
				...
				if ($link) {
					...
					$output .= '<span class="icon">';
						$output .= '<i class="'. esc_attr($icon) .'"></i>';
					$output .= '</span>';
					$output .= '<p>'. wp_kses($title, mfn_allowed_title()) .'</p>';
		...
		$output = '<div class="list_item lists_'. esc_attr($style) .' clearfix">';
			if ($animate) {
				...
				if ($link) {
					...
					if ($style == 4) {
						$output .= '<div class="circle">'. wp_kses($title, mfn_allowed_title()) .'</div>';
					} elseif ($image) {
